...
def attack(char_name: str, char_class: str) -> str:
    ...
    Зависимости от выбранного типа персонажа и возвращает
    строковое сообщение о проведённой атаке.

    Args:
        char_name (str): имя персонажа
        char_class (str): типа персонажа

    Returns:
        str: строковое сообщение
    """
...
def defence(char_name: str, char_class: str) -> str:
    ...
    Зависит от выбранного типа персонажа и возвращает
...
def special(char_name: str, char_class: str) -> str:
    ...
    Зависит от выбранного типа персонажа.
